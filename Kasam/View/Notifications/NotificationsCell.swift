...
class NotificationsCell: UITableViewCell {
    ...
    @IBAction func editButtonPressed(_ sender: Any) {
        ...
        addKasamPopup(kasamID: kasamID, percentComplete: nil, new: false, timelineDuration: SavedData.kasamDict[kasamID]?.timeline, duration: SavedData.kasamDict[kasamID]!.repeatDuration, fullView: false)
