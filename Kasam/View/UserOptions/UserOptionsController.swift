            ...
            switch indexPath.row {
                ...
                case 1:
                    if SavedData.userType == "Pro" {
                        ...
                        showOptionsPopup(title: nil, text: "You'll need to go Pro to create a complex kasam", type:"goPro", button: "Go Pro!")
                }
                case 2:
                    NotificationCenter.default.post(name: Notification.Name(rawValue: "GoToNotifications"), object: self)
                    SwiftEntryKit.dismiss()
                case 3:
                    showOptionsPopup(title: "Are you sure?", text: nil, type:"logout", button: "Logout")
