...
- (void)layoutSubviews
{
    ...
    if (_needsAdjustingViewFrame) {
        ...
        //Below change made
        NSInteger offsetFromHeader = 10;
        
        self.calendarHeaderView.frame = CGRectMake(0, 0, self.fs_width, headerHeight);
        self.calendarWeekdayView.frame = CGRectMake(0, self.calendarHeaderView.fs_bottom + offsetFromHeader, self.contentView.fs_width, weekdayHeight);
        ...
        if (!self.floatingMode) {
            switch (self.transitionCoordinator.representingScope) {
                case FSCalendarScopeMonth: {
                    ...
                    _daysContainer.frame = CGRectMake(0, headerHeight+weekdayHeight + offsetFromHeader, self.fs_width, contentHeight);
